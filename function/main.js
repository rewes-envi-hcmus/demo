$(document).ready(function () {
    ...
    chart = new CanvasJS.Chart("chart1", {
      ...
      axisY: {
        ...
        labelFormatter: function (e) {
          return e.value.toFixed(2) + " " + labelY;
        },
      },
      data: [
        {
  ...
  function drawChartDose(title, titleY, labelY) {
    chart = new CanvasJS.Chart("chart1", {
      theme: "light2",
      title: {
        text: title,
      ...
      axisY: {
        title: titleY,
        labelFormatter: function (e) {
          return e.value.toFixed(4) + " " + labelY;
        },
      },
      data: [
        {
    ...
    getData().then(function (data) {
      ...
      switch (active) {
        ...
        case "khi_co2":
          ...
          break;
        case "khi_ch4":
          updateChart(x, { label: label, value: response.CH4 });
          break;
        case "sensor3":
